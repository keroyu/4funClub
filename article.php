	...
	<div class="row">
		<div class="row-col col-640">
			...
			<div class="articleWrapper">
				<div class="hidden-md articleShareBox">
				...
				<div class="article">
					...
					<article>
						...
						<div class="text-center">
							<img src="upload/400x300.gif" alt="">
			...
			<ul class="media-blocks margin-tb">
				<li><a href="article.php"><div>
					...
					<div><img src="upload/300x165.gif" alt="">
		...
		<div class="row-col col-300 hidden-sm">
			<div class="adbox adbox-300 margin-btm"><img src="upload/300x300.gif" alt=""></div>
